...
import '../Css/Grid.css';
import './NewsLetterSuscribing.css';
const SERVER_ADDRESS = process.env.REACT_APP_SERVER_ADDRESS;


class NewsLetterSuscribing extends Component {
    constructor(props) {
        super(props);
        this.state = {
            email: '',
    ...
    render() {
        const { email } = this.state;
        return (
            <div className="dsk-12 tab-12 mob-12 column alignItemCenter separateurBlock">
            <section className="section3 dsk-4 tab-5 mob-12 justContCenter column blueDiv paddingTopBottom25px" onSubmit={this.handleContactSubmit} >
                <h3 className="textAlignCenter">Ceci est un superbe</h3>
                <h1 className="textAlignCenter">TITRE PROVISOIRE</h1>
