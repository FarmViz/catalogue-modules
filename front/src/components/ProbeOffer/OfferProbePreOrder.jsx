        ...
        return (
            <>
                <div className="dsk-8 tab-8 mob-12 blueDiv inter-media-offer">
                    <div className=" dsk-10 tab-10  mob-11 column align-items-flex-end ">
                        <h1 className="yellow graisse600 marginT1 alig">PRÉ-COMMANDER</h1>
                        <h2 className=" text14Bold marginB1">votre PACK MOBILE</h2>
                        <h3 className=" text14Bold">Sonde de thermométrie intelligente</h3>
                        <div className=" dsk-8 tab-10 mob-11 row contentFlexEnd marginT1">
                    ...
                    <div className=" dsk-9 tab-10 mob-10 column  align-items-flex-end">
                    ...
                    <div className="dsk-9 tab-10 mob-10 row flex-end">
                        <div className="marginB10">
                            <a href="/decouvrir" className="souligner text12 ">Découvrir</a>
                            <button className="button_transparent graisse600 marginL3"> <a href="/ventilation">PRÉ-COMMANDER</a></button>
                        </div>
                    </div>
