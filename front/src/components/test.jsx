...
class Test extends Component {
    ...
    render() {
        return (
            ...
            <>
                <div className="mob-12 tab-12 tabx-12 dsk-12 column ">
                    <div className="dsk-12 row">
                        <h1 className="dsk-4 flex-center">Arial- Black regular 36</h1>
                        <h2 className="dsk-4">Arial - Bold 30</h2>
                        <h3 className="dsk-4">Arial - Bold 24</h3>
                    </div>
                    <h4>Arial - Bold 20</h4>
